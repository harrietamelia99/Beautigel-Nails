...
const GEL_WRAP_USPS = [
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M13 2.05V4.08c3.39.49 6 3.39 6 6.92 0 2.73-1.56 5.11-3.87 6.37L13 15v5h5l-1.22-1.22C18.91 17.07 21 14.14 21 11c0-4.96-3.96-9.02-8-8.95zM11 2.05C6.96 3.03 4 6.77 4 11c0 3.14 2.09 6.07 5 7.78L7 20h5v-5l-2.13 2.37C8.56 16.11 7 13.73 7 11c0-3.53 2.61-6.43 6-6.92V2.05h-2z"/></svg>, title: 'Quick & Easy', desc: 'Salon-quality nails in minutes' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm4.24 16L12 15.45 7.77 18l1.12-4.81-3.73-3.23 4.92-.42L12 5l1.92 4.53 4.92.42-3.73 3.23L16.23 18z"/></svg>, title: 'Long-Lasting', desc: 'Gorgeous wear for 2–3 weeks' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>, title: 'Premium Finish', desc: 'Smooth, glossy, elegant gel look' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M17 8C8 10 5.9 16.17 3.82 21H5.8c.35-.75.72-1.5 1.1-2.2 1.46.5 3.05.7 4.6.5C15 18.5 19 14 19 14c-2 2-4.5 3-7 3.5-.38.08-.77.13-1.15.16.11-.33.22-.66.35-1 .89-2.49 2.62-4.65 5.8-6.66zm-7.5 9.5c.45-.05.9-.14 1.34-.27C13.9 15.88 16 13.77 17 12c-2.5 2.5-5 4-8 4.5-.17.03-.34.05-.5.08z"/></svg>, title: 'Gentle on Nails', desc: 'Removes easily without damage' },
]

const UV_LAMP_USPS = [
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>, title: 'Professional Quality', desc: 'Salon results at home' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm.01 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z"/></svg>, title: 'Fast Cure', desc: 'Cures wraps in 60–90 seconds' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M20 6h-2.18c.07-.44.18-.86.18-1.3 0-2.76-2.24-5-5-5S8 1.94 8 4.7c0 .44.11.86.18 1.3H6C4.9 6 4 6.9 4 8v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-7-4.1c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7-2.7-1.21-2.7-2.7S11.51 1.9 13 1.9z"/></svg>, title: 'Hard Glossy Finish', desc: 'Chip-resistant, long-lasting' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M21 3L3 10.53v.98l6.84 2.65L12.48 21h.98L21 3z"/></svg>, title: 'Compact & Light', desc: 'Easy to use and store' },
]

const CUTICLE_OIL_USPS = [
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M12 2c0 0-6 6.5-6 10.5a6 6 0 0 0 12 0C18 8.5 12 2 12 2z"/></svg>, title: 'Nourishes & Moisturises', desc: 'Keeps cuticles soft and healthy' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M12 2a5 5 0 1 0 0 10A5 5 0 0 0 12 2zm0 12c-5.33 0-8 2.67-8 4v2h16v-2c0-1.33-2.67-4-8-4z"/></svg>, title: 'Strengthens Nails', desc: 'Delivers vitamins and nutrients' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M17 8C8 10 5.9 16.17 3.82 21H5.8c.35-.75.72-1.5 1.1-2.2 1.46.5 3.05.7 4.6.5C15 18.5 19 14 19 14c-2 2-4.5 3-7 3.5-.38.08-.77.13-1.15.16.11-.33.22-.66.35-1 .89-2.49 2.62-4.65 5.8-6.66z"/></svg>, title: 'Cruelty-Free & Vegan', desc: 'Kind to you and the planet' },
  { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill={BLUE}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, title: 'Protects & Revitalises', desc: 'Supports natural nail growth' },
]
...
function Accordion({ title, children }: { title: string; children: React.ReactNode }) {
  ...
  return (
    <div className="border-t border-nude">
      ...
      {open && <div className="pb-5 text-mocha text-sm leading-relaxed">{children}</div>}
    </div>
  )
}
...
export function ProductDetail({ product }: { product: Product }) {
  ...
  const [selectedOptions, setSelectedOptions] = useState<Record<string, string>>(() => {
    ...
    product.variants[0]?.selectedOptions.forEach(({ name, value }) => { opts[name] = value })
    return opts
  })
  ...
  useEffect(() => {
    getProducts(6).then((products) => {
      ...
      setRelated(list.filter((p) => p.handle !== product.handle).slice(0, 4))
    })
  }, [product.handle])
  ...
  return (
    <div className="bg-ivory min-h-screen">
      ...
      <div className="section-padding py-10 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-3">
            <div className="relative aspect-[3/4] bg-nude rounded-2xl overflow-hidden">
              {product.images[activeImage] ? (
                <Image src={product.images[activeImage].url} alt={product.images[activeImage].altText ?? product.title} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" priority />
              ) : (
                <div className="absolute inset-0 flex items-center justify-center text-mocha/20 text-7xl">💅</div>
              )}
              {product.isPreOrder && <div className="absolute top-4 left-4"><PreOrderBadge estimatedShipDate={product.estimatedShipDate} /></div>}
            </div>
            {product.images.length > 1 && (
              <div className="flex gap-2">
                {product.images.slice(0, 5).map((img, i) => (
                  <button key={i} onClick={() => setActiveImage(i)} className={`w-14 h-16 rounded-xl overflow-hidden transition-all shrink-0 ${activeImage === i ? 'opacity-100' : 'opacity-50 hover:opacity-100'}`} style={activeImage === i ? { outline: '2px solid #b4cbe6', outlineOffset: '2px' } : {}}>
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-4">
              {product.availableForSale ? (
                <span className="flex items-center gap-1.5 text-xs text-mocha"><span className="w-1.5 h-1.5 rounded-full bg-green-400 inline-block" />In stock · ships within 1–2 business days</span>
              ) : (
            ...
            {product.options.filter((opt) => opt.values.length > 1 || opt.values[0] !== 'Default Title').map((option) => (
              <div key={option.name} className="mb-6">
                <p className="label-text text-charcoal mb-3">{option.name}:&nbsp;<span className="normal-case tracking-normal font-normal text-mocha">{selectedOptions[option.name]}</span></p>
                <div className="flex flex-wrap gap-2">
                  {option.values.map((value) => (
                    <button key={value} onClick={() => handleOptionChange(option.name, value)} className={`px-4 py-2 rounded-full text-xs tracking-wide border transition-all ${selectedOptions[option.name] === value ? 'bg-charcoal text-ivory border-charcoal' : 'border-nude text-mocha hover:border-charcoal hover:text-charcoal'}`}>{value}</button>
                  ))}
                </div>
              </div>
            ))}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-8">
              {[
                ...
                <div key={t.label} className="flex flex-col items-center text-center gap-1.5 bg-nude/50 rounded-2xl p-3">{t.icon}<span className="text-[9px] text-mocha tracking-wide leading-tight">{t.label}</span></div>
              ))}
            </div>
              ...
              {product.productType === 'Gel Wraps' && (
                <Accordion title="Ingredients">
                  <div className="space-y-3">
                    <p className="text-mocha text-xs leading-relaxed">Polyacrylic Acid, Acrylates Copolymer, Glycerine Propoxylate Triacrylate, Isopropylthioxanthone.</p>
                    <p className="text-mocha text-xs leading-relaxed"><span className="text-charcoal font-medium">May contain: </span>D&amp;C Red No.6 Barium Lake, D&amp;C Red No.7 Calcium Lake, FD&amp;C Yellow No.5 Aluminum Lake, D&amp;C Yellow No.10, FD&amp;C Blue No.1, Black Iron Oxide, Titanium Dioxide, Bismuth Oxychloride, Mica.</p>
                    <p className="text-[9px] text-mocha/50 italic">Ingredient declaration correct at time of publishing. For allergen queries please contact us before purchase.</p>
                  </div>
                </Accordion>
              )}
        ...
        {product.productType === 'Gel Wraps' && (
          <div className="-mx-4 sm:-mx-6 lg:-mx-8"><NailFormulaSection /></div>
        )}
